...
$taskName="TSecScan-ShareAnalyse"
...
$cmd='-ExecutionPolicy Bypass "& ''d:\Program Files\TSecScan\OpenShares\ShareAnalyse.ps1'' -NoProfile -Config \etc\OpenShares.ini >>D:\data\w5secscan\log\OpenShares.log 2>&1'

$TaskTrigger = New-ScheduledTaskTrigger -At 21:45 -Daily;
